...
const MoviePoster =  () => {
    ...
    return (
        <>
            <div className="absolute top-0 bg-red-500 w-10 flex items-center justify-center h-10 rounded-full">
                <i className="fa-solid fa-arrow-left"></i>
            </div>
            <div className="relative w-full h-screen">
                <div className="relative  h-[50%] w-full">
                    {/* Header section */}
                    <img src={`${baseUrlImg}/${detailValue.backdrop_path}`} alt="" className={`absolute brightness-50 object-center w-full h-full object-cover`} />
